        ...
        <div className="xl:hidden fixed left-4 bottom-4 z-50">
          <ToolTip content="Show Panel">
            <Button
              ...
              className="bg-[#0066ff] text-white p-3 rounded-full shadow-lg"
            >
                ...
                {isStreaming ? (
                  ...
                  presentationData?.slides.map((slide: any, index: number) => (
                    <div
                      ...
                      className={` cursor-pointer ring-2 p-1  rounded-md transition-all duration-200 ${selectedSlide === index ? ' ring-[#0066ff]' : 'ring-gray-200'
                        }`}
                    >
