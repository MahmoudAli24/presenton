  ...
  const ExportOptions = ({ mobile }: { mobile: boolean }) => (
    <div className={`space-y-2 max-md:mt-4 ${mobile ? "" : "bg-white"} rounded-lg`}>
      <Button
        ...
        variant="ghost"
        className={`pb-4 border-b rounded-none border-gray-300 w-full flex justify-start text-[#0066ff] ${mobile ? "bg-white py-6 border-none rounded-lg" : ""}`} >
      ...
      <Button
        ...
        variant="ghost"
        className={`w-full flex justify-start text-[#0066ff] ${mobile ? "bg-white py-6" : ""}`}
      >
      ...
      <div style={{
        ...
        <Popover open={open} onOpenChange={setOpen} >
          <PopoverTrigger asChild>
            <Button className={`border py-5 text-[#0066ff] font-bold rounded-[32px] transition-all duration-500 hover:border hover:bg-[#0066ff] hover:text-white w-full ${mobile ? "" : "bg-white"}`}>
  ...
  return (
    <>
      ...
      <div
        ...
        className="bg-[#0066ff] w-full shadow-lg sticky top-0 ">
